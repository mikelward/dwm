...
static const char *fonts[]          = { "Ubuntu-12" };
static const char dmenufont[]       = "Ubuntu Mono-14";
...
static const Layout layouts[] = {
	...
	{ "|[]=",     firstcenter },     /* first entry is default */
	{ "[]=",      vertile },
	{ "[M]",      monocle },
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_grave,  setlayout,      {.v = &layouts[2]} },
	{ MODKEY,                       XK_period, setlayout,      {.v = &layouts[3]} },
	{ MODKEY|ControlMask,           XK_Tab,    setlayout,      {0} },
